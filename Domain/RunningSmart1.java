...
public class RunningSmart1 extends Player {
 ...
 /*Subclases*/
    public RunningSmart1(String nameImage, String nameThead, Double time, int x, int y, Block object[][]) throws FileNotFoundException {
    ...
    public void setSprite() throws FileNotFoundException {
        ...
        //sprite.add(new Image(new FileInputStream("src/Assets/E2.png")));
    ...
    public void run() {
        ...
        try {
            ...
            Logger.getLogger(RunningSmart1.class.getName()).log(Level.SEVERE, null, ex);
        }
        while (ejecutar) {
            try {
                v = (this.getX()) / 40;
